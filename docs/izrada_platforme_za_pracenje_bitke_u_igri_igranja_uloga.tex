...
U primjeru ispod prikazana je struktura kontejnera za crtanje i prikaz tokena u trenutku kad ga korisnik
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{slike/pixi-containers.png}
