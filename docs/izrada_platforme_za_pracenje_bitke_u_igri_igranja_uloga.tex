...
Na slici ispod se nalazi primjer prazne stranice lista o liku (engl. character sheet).
...
sadrži podatke o čarolijama pripremljenim i znanim čarolijama, te razinama
...
% snaga, spremnost, izdržljivost, inteligencija, mudrost i karizma, u svaku
...
\begin{figure}[H]
    ...
    \caption{Character sheet - Prva stranica\cite{charactershet2014}}
...
\begin{figure}[H]
    ...
    \caption{Character sheet - Druga stranica\cite{charactershet2014}}
...
\begin{figure}[H]
    ...
    \caption{Character sheet - Treća stranica\cite{charactershet2014}}
...
s određenim oružjem ili alatima, vrsnost u jednoj ili više vještina ili 
...
starost lika, moralni kompas, veličina, brzina, jezici koje lik razumije
...
Ukratko ćemo proći kroz različite rase i njihove osobine i sposobnosti:
