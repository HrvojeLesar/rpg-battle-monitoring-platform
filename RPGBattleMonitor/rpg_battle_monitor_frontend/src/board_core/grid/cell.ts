...
export class GridCell extends Point implements IGridMove {
    ...
    private setCellPosition(position: GridCellPosition): void {
        ...
        this.container.position.set(
            this.x * this.grid.container.cellSize,
            this.y * this.grid.container.cellSize,
        );
    }

    private calculateCellPosition() {
        this.set(
            Math.floor(this.container.x / this.grid.container.cellSize),
            Math.floor(this.container.y / this.grid.container.cellSize),
        );
    }
