...
Igre igranja uloga (engl. \textit{Role playing games}),
su doživjele značajan porast u popularnostu u posljednjem desetljeću, kako u klasičnim
...
Zaključak - sinteza rada (ne sažetak) s kritičkim prikazom (što je dobro napravljeno, što je moglo bolje, što bi se u budućnosti moglo proširiti)
