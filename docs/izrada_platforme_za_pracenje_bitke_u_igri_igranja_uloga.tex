...
\texttt{state}. U funkciji su definirane tri različite rute, detalji o rutama su poglavlju \ref{section:endpoints}.
...
konkretnije objašnjeno gdje se, u ovom kontekstu, globalno stanje koristi.
...
definirana je od strane klijenta tj. implementacije igre.
